              ...
              <div className="row gy-4">
                ...
                >
                  <div className={styles["why-box"]}>
                    ...
                    <p>
                      At Secure Cycling, we're not just about bikes; we're about
                      creating a culture of security and safety for all riders.
                      Our unmatched dedication ensures that every cyclist gets
                      the best tools, resources, and community support, making
                      their journey safer and more enjoyable.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="row gy-4">
                    ...
                    >
                      <div className="icon-box d-flex flex-column justify-content-center align-items-center">
                        ...
                        <p>
                          With our in-depth safety research and data analytics,
                          we provide insights that make cycling more secure for
                          everyone.
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      <div className="icon-box d-flex flex-column justify-content-center align-items-center">
                        ...
                        <p>
                          ...
                          support, shared experiences, and genuine care for each
                          member.
                        </p>
                      </div>
                    </div>
